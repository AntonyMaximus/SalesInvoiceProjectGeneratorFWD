 ...
 *
 */
public class InvoiceTitleTable extends AbstractTableModel {

    private final ArrayList<InvoiceTitle> invoicesData;
    private final String[] invoiceHeaderColumns = {"No.", "Date", "Customer", "Total"};
    
     public InvoiceTitleTable(ArrayList<InvoiceTitle> invoicesData) {
